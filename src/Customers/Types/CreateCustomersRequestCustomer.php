...
class CreateCustomersRequestCustomer extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?string $email Customer's email address (unique per store; required if phone is blank)
     */
    #[JsonProperty('email')]
    public ?string $email;

    /**
     * @var ?array<string> $externalReferences Array of `{source, external_id, metadata}` objects linking this customer to records in external systems
     */
    ...
    /**
     * @var ?array<string, mixed> $metadata Free-form JSON object of additional per-customer attributes
     */
    #[JsonProperty('metadata'), ArrayType(['string' => 'mixed'])]
    public ?array $metadata;

    /**
     * @var ?string $phone Customer's phone number (unique per store; required if email is blank)
     */
    #[JsonProperty('phone')]
    public ?string $phone;
